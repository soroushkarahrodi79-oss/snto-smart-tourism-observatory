...
from src.platform.evidence import (
    DecisionUse, gating_matrix, legend as evidence_legend,
)
...
from src.ui.render_widgets import (
    _compute_exec_kpis, _render_banner, _render_exec_kpis,
    _render_fichas_rapidas, _render_live_alerts, render_kpi_card,
)
...
# ── Leyenda canónica de clases de evidencia (ADR-004 / #10) ──────
