...
def build_real_trails_deck(
    ...
    tooltip = {
        "html": (
            ...
            "letter-spacing:.05em;padding:1px 5px;text-transform:uppercase'>"
            "Modelo SIG</span><br/>"
            "<span style='font-size:11px;color:#c8d6e5'>Atribución SCM: "
            "{scm}</span><br/>"
            "<span style='font-size:10px;color:#8a97a6;font-style:italic'>"
            "No constituye medición causal ni causa confirmada.</span><br/>"
