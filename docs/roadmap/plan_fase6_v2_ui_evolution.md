...
| 6.7d+ | Módulos P2/P3 restantes de la tabla de prioridad (spec §6): proveniencia, generador de informes, configuración territorial | Variable, uno por PR | Depende de cada módulo |
