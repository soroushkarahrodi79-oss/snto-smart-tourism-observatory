...
>
> **Fechas previstas**
> [PLACEHOLDER — pending confirmation of the target field season, `DATA_ACQUISITION_TRIAGE.md` open item]. Indicatively: peak Mediterranean-montane growing season (mid-June to mid-August), timed to a Sentinel-2 acquisition window defined in advance (`SATELLITE_FIELD_MATCHING_PLAN.md` §2). Weather-conditional: penetrometer readings require ≥ 48 h since significant rainfall.
>
