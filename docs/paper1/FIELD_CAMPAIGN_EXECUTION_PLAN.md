...
| **P-3** | **The originally seeded targets were not trails.** Porrones is a climbing polygon; El Nevero is a paragliding point. | A trail-impact paper cannot be built on them. | **Resolved 2026-08-09.** Contract §F frozen to F-1 — sampling frame is the 218 real OAPN trails. Site selection (§2) draws from that network, not from the old template's two assets. |
