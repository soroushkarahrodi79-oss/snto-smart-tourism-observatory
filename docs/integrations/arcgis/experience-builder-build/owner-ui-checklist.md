...
propietario (`OWNER_MANUAL_UI`); ver `batch-a-execution-record.md`.
**Batch B: ✅ `OWNER_EXECUTED_AND_VERIFIED` (2026-08-01)** — backup privado +
popups B1/B2 + B3 sin filtros + B4 preservado; ver `batch-b-execution-record.md`.
**Batch C** (creación de la app, Puertas 3–7): **pendiente** de
